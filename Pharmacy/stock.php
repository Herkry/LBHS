...
$query = "SELECT medId, medName, medUnitPrice, medTotAmt, medUnitAmt, medUnitCharge FROM `medicine` WHERE pharmId = '$pharmId'";
...
<td>
<form action='editMedicinePr.php' method='post'>
...
<td>
<input type = 'hidden' name = 'pharmId' value = '".$pharmId."'/>
...
if(isset($_POST['medName']) && isset($_POST['medUnitPrice']) && isset($_POST['medTotAmt']) && isset($_POST['medUnitAmt'])) { 
$medName = $_POST['medName'];
$medUnitPrice = $_POST['medUnitPrice'];
$medTotAmt = $_POST['medTotAmt'];
$medUnitAmt =$_POST['medUnitAmt'];

$insertMedicine = "INSERT INTO medicine (medName, medUnitPrice, medTotAmt, medUnitAmt, pharmId)
VALUES ('$medName', '$medUnitPrice', '$medTotAmt', '$medUnitAmt', '$pharmId')";
setData($insertMedicine);
...
if(isset($_POST['delete'])){
   $medId = $_POST['medId'];
   $deleteData = "DELETE FROM medicine WHERE medId = '$medId'";
   setData($deleteData);
   echo("<script> window.location.replace('stock.php'); </script>");
}
