...
$link = connect();
if(isset($_POST["ambId"])){
$ambId = $_POST["ambId"];
$query = "SELECT ambId, ambNoPlate, ambType, ambDriverName, ambDriverPhone, ambCapacity, ambEmail FROM `ambulance` WHERE ambId = '$ambId' ";
...
<tr>
<form action ='updateambPr.php' method='post' >

<td>
<input type = 'text' class='form-control'    name = 'ambNoPlate' placeholder='edit'/>
</td>

<td>
<input type = 'text' class='form-control'  name = 'ambType'  placeholder='edit'/>
</td>

<td>
<input type = 'text' class='form-control'  name = 'ambDriverName' placeholder='edit' />
</td>

<td>
<input type = 'text' class='form-control'  name = 'ambDriverPhone' placeholder='edit' />
</td>

<td>
<input type = 'text' class='form-control'  name = 'ambCapacity' placeholder='edit' />
</td>

<td>
<input type = 'text' class='form-control'  name = 'ambEmail' placeholder='edit' />
</td>
