...
$patId = $_POST["patId"];
$query = "SELECT patId, patFname, patLname, patPhone, patEmail, patAddress, patDOB FROM `patient` WHERE patId = '$patId' ";
...
<tr>
<form action ='updatepatPr.php' method='post' >

<td>
<input type = 'text' class='form-control'    name = 'patFname' placeholder='edit'/>
</td>

<td>
<input type = 'text' class='form-control'  name = 'patLname'  placeholder='edit'/>
</td>

<td>
<input type = 'text' class='form-control'  name = 'patPhone' placeholder='edit' />
</td>

<td>
<input type = 'text' class='form-control'  name = 'patEmail' placeholder='edit' />
</td>
