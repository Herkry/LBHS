...
$fName = $lName = $username = $address = $password = $confirm_password = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $sql = "SELECT adminId FROM superadmin WHERE adminFname = ?";
        ...
        $lName_err = "Please enter a last name.";
			        ...
			        // Prepare a select statement
        $sql = "SELECT adminId FROM superadmin WHERE adminLname = ?";
        ...
        if(empty(trim($_POST["address"]))){
            $address_err = "Please enter an address.";
                        ...
                        // Prepare a select statement
            $sql = "SELECT adminId FROM superadmin WHERE adminAddress = ?";
    ...
    if(empty(trim($_POST["username"]))){
        ...
        // Prepare a select statement
        $sql = "SELECT adminId FROM superadmin WHERE adminEmail	 = ?";
    ...
    if( empty($fName_err) && empty($lName_err) && empty($username_err) && empty($address_err) && empty($password_err) && empty($confirm_password_err)){
        
        // Prepare an insert statement
        $sql = "INSERT INTO superadmin (adminFname, adminLname, adminEmail	, adminAddress, adminPassword) VALUES (?,?,?,?,?)";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sssss", $param_fName, $param_lName,$param_username,  $param_address, $param_password);
