  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="#"style="color: white;">Activities</a></li>
        ...
        <li ><a href="logout.php" style="color: white;"><span class="glyphicon glyphicon-log-in"></span> Logout</a></li>
		   ...
		   <div id="back">
			  ...
			  <div id="sublabel33">
				     ...
				     <a href="doc-reg.php" style="color: #FDFEFE">Register Doctor</a>
           ...
           <div id="label3">
			  ...
			  <div id="sublabel33">
				     ...
				     <a href="nurse-reg.php" style="color: #FDFEFE">Register Nurse</a>
           ...
           <div id="label3">
			  ...
			  <div id="sublabel33">
				     ...
				     <a href="pharm-reg.php" style="color: #FDFEFE">Register Pharmacist</a>
