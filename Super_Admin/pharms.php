...
$query = "SELECT pharmId, pharmName, pharmPhone, pharmEmail, pharmAddress FROM `pharmacy` ";
...
<td>
<form action='updatepharm.php' method='post'>
...
if(isset($_POST['delete'])){
    ...
    $deleteData = "DELETE FROM pharmacy WHERE pharmId = '$pharmId'";
    setData($deleteData);
